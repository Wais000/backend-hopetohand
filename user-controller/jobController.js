...
export const updateJob = async (req, res) => {
    const { id } = req.params;
    const {contactEmailJob, contactPersonJob,  contactNumberJob,   TypeOfLanguageJob,jobList, address,salaryBasisJob,endDateJob, startDateJob,jobProvider, cityJob, jobType, numberOfPersons  } = req.body;
    try {
    const job = await jobFormModel.findByIdAndUpdate(id, {
        contactEmailJob, contactPersonJob,  contactNumberJob,   TypeOfLanguageJob,jobList, address,salaryBasisJob,endDateJob, startDateJob,jobProvider, cityJob, jobType, numberOfPersons
