...
// import { postAvatar } from "../user-controller/userAvatarController.js";
import  {postAvatar, getUserAvatar} from "../user-controller/userAvatarController.js"
import {uploadPicture} from "../user-controller/usersController.js";
...
router.patch("/updateaccomodation/:id", updateAccomodation);

// user Avatar
router.get("/getuseravatar", auth, getUserAvatar)
router.post("/volunteerformspage/postavatar",auth, uploadPicture);
...
router.patch("/updatehelp/:id", updateHelp);
